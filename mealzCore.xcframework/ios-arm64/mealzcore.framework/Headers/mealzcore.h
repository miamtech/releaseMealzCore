...
@class MealzcoreKotlinThrowable, MealzcoreMealz, MealzcoreSdkBuilder, MealzcoreMealzBasket, MealzcoreMealzCatalog, MealzcoreMealzEnvironment, MealzcoreMealzNotifications, MealzcoreMealzPayment, MealzcoreMealzRecipe, MealzcoreMealzUser, MealzcoreCatalogCategory, MealzcoreSupportedLanguage, MealzcoreAuthorization, MealzcoreKMMContext, MealzcoreMiamPreferencesContext, MealzcoreKotlinEnumCompanion, MealzcoreKotlinEnum<E>, MealzcoreOperatingSystem, MealzcoreKotlinArray<T>, MealzcoreSdkVersion, MealzcoreExecutorHelperCompanion, MealzcoreKotlinx_coroutines_coreCoroutineDispatcher, MealzcoreKotlinAbstractCoroutineContextElement, MealzcoreKotlinx_coroutines_coreCoroutineDispatcherKey, MealzcoreMainLoopDispatcher, MealzcoreMainExecutor, MealzcoreBasicUiState<__covariant T>, MealzcoreBasicUiStateEmpty, MealzcoreKotlinNothing, MealzcoreBasicUiStateError, MealzcoreBasicUiStateIdle, MealzcoreBasicUiStateLoading, MealzcoreBasicUiStateSuccess<T>, MealzcoreComponentUiState, MealzcoreRecipe, MealzcoreRecipePricing, MealzcoreSuggestionsCriteria, MealzcoreRecipeSort, MealzcoreRecipeFilter, MealzcoreBudgetRepositoryCompanion, MealzcoreSponsorBlock, MealzcoreBasket, MealzcoreRecipeInfos, MealzcoreStartTransferResponse, MealzcoreItem, MealzcoreBasketEntry, MealzcoreIngredient, MealzcoreItemPrice, MealzcoreItemSelectorWithBasketEntryNavigationData, MealzcoreItemSelectorWithIngredientNavigationData, MealzcoreItemSelectorNavigationData, MealzcorePointOfSale, MealzcorePointOfSaleRepositoryCompanion, MealzcoreRecipeRepositoryImpCompanion, MealzcoreRetailerRepositoryCompanion, MealzcoreSupplier, MealzcoreAuthLessUser, MealzcoreMealzDI, MealzcoreSingletonPreferencesViewModel, MealzcoreRecipeRepositoryImp, MealzcoreRouteService, MealzcoreLogHandlerCompanion, MealzcoreLogHandlerLogLevels, MealzcoreSdkRequirement, MealzcoreI18nResolver, MealzcoreI18n, NSBundle, MealzcoreLocalisation, MealzcoreBasketI18N, MealzcoreBudgetI18N, MealzcoreCatalogI18N, MealzcoreCounterI18N, MealzcoreErrorI18N, MealzcoreFavoritesI18N, MealzcoreFiltersI18N, MealzcoreIngredientI18N, MealzcoreItemSelectorI18N, MealzcoreMyBasketI18N, MealzcoreMyMealsI18N, MealzcoreMyProductsI18N, MealzcoreMyProductsProductI18N, MealzcorePreferencesI18N, MealzcorePriceI18N, MealzcoreRecipeI18N, MealzcoreRecipeDetailsI18N, MealzcoreRecipeDetailsProductI18N, MealzcoreSponsorBannerI18N, MealzcoreSponsorDetailI18N, MealzcoreStoreLocatorButtonI18N, MealzcoreTagI18N, MealzcoreI18nCompanion, MealzcoreResourcesPluralsResource, MealzcoreResourcesStringResource, MealzcoreNoResourceThrowable, MealzcoreAlterQuantityBasketEntry, MealzcoreAttributesCompanion, MealzcoreAuthLessUserCompanion, MealzcoreRecordCompanion, MealzcoreKotlinx_serialization_jsonJsonElement, MealzcoreAttributes, MealzcoreRelationships, MealzcoreRecord, MealzcoreBasketCompanion, MealzcoreBasketAttributes, MealzcoreBasketRelationships, MealzcoreAttributesField, MealzcoreBasketStatus, MealzcoreBasketAttributesCompanion, MealzcoreBasketEntriesItemCompanion, MealzcoreBasketEntriesItem, MealzcoreBasketEntryCompanion, MealzcoreBasketEntryAttributes, MealzcoreBasketEntryRelationships, MealzcoreBasketEntryCompanionStates, MealzcoreBasketEntryAttributesCompanion, MealzcoreRelationshipListCompanion, MealzcoreRelationshipList, MealzcoreBasketEntryRelationshipListCompanion, MealzcoreBasketEntryRelationshipListSerializer, MealzcoreBasketEntryRelationshipList, MealzcoreRelationshipsCompanion, MealzcoreItemRelationshipList, MealzcoreItemRelationship, MealzcoreBasketEntryRelationshipsCompanion, MealzcoreBasketPreviewInfo, MealzcoreBasketPriceCompanion, MealzcoreBasketPrice, MealzcoreBasketRelationshipsCompanion, MealzcoreBasketStatusCompanion, MealzcoreBasketStatusSerializer, MealzcoreCatalogFilterOptions, MealzcoreTagTypes, MealzcoreTag, MealzcoreCheckableTagCompanion, MealzcoreCheckableTag, MealzcoreIngredientCompanion, MealzcoreIngredientAttributes, MealzcoreIngredientRelationships, MealzcoreIngredientAttributesCompanion, MealzcoreIngredientListRelationshipCompanion, MealzcoreIngredientListSerializer, MealzcoreIngredientListRelationship, MealzcoreItemCompanion, MealzcoreItemAttributes, MealzcoreItemRelationships, MealzcoreItemAttributesCompanion, MealzcoreItemPriceCompanion, MealzcoreRelationshipCompanion, MealzcoreRelationship, MealzcoreItemRelationshipCompanion, MealzcoreItemRelationshipListCompanion, MealzcoreItemRelationshipListSerializer, MealzcoreItemRelationshipSerializer, MealzcoreItemRelationshipsCompanion, MealzcoreMealPlannerRecipe, MealzcoreMiamConfigCompanion, MealzcoreMiamConfig, MealzcorePackageCompanion, MealzcorePackage, MealzcorePackageAttributes, MealzcorePackageRelationships, MealzcorePackageSettings, MealzcorePackageAttributesCompanion, MealzcoreRecipeRelationshipList, MealzcorePackageRelationshipsCompanion, MealzcorePackageSettingsCompanion, MealzcorePointOfSaleAttributes, MealzcorePointOfSaleCompanion, MealzcorePointOfSaleAttributesCompanion, MealzcoreRecipeCompanion, MealzcoreRecipeAttributes, MealzcoreRecipeRelationships, MealzcoreRecipeLike, MealzcoreRecipeDifficulty, MealzcoreRecipeStep, MealzcoreRecipeAttributesCompanion, MealzcoreRecipeInfosCompanion, MealzcoreRecipeLikeCompanion, MealzcoreRecipeLikeAttributes, MealzcoreRecipeLikeRelationships, MealzcoreRecipeLikeAttributesCompanion, MealzcoreRecipeLikeRelationshipsCompanion, MealzcoreRecipePlanCompanion, MealzcoreRecipePlan, MealzcoreRecipePricingCompanion, MealzcoreRecipeRelationshipListCompanion, MealzcoreRecipeRelationshipListSerializer, MealzcoreSponsorListRelationship, MealzcoreRecipeStepListRelationship, MealzcoreTagListRelationship, MealzcoreRecipeRelationshipsCompanion, MealzcoreRecipeStepCompanion, MealzcoreRecipeStepAttributes, MealzcoreRecipeStepRelationships, MealzcoreRecipeStepAttributesCompanion, MealzcoreRecipeStepListListSerializer, MealzcoreRecipeStepListRelationshipCompanion, MealzcoreRecipeStepRelationshipsCompanion, MealzcoreRecordLink, MealzcoreRecordCounterWrapperCompanion, MealzcoreRecordCounterWrapper, MealzcoreRecordLinkCompanion, MealzcoreRecordWrapperCompanion, MealzcoreRecordWrapper, MealzcoreSponsorCompanion, MealzcoreSponsor, MealzcoreSponsorAttributes, MealzcoreSponsorRelationships, MealzcoreSponsorAttributesCompanion, MealzcoreSponsorBlockCompanion, MealzcoreSponsorBlockAttributes, MealzcoreSponsorBlockRelationships, MealzcoreSponsorBlockAttributesCompanion, MealzcoreSponsorBlockRelationshipName, MealzcoreSponsorBlockTypeRelationship, MealzcoreSponsorBlockRelationshipsCompanion, MealzcoreSponsorBlockTypeCompanion, MealzcoreSponsorBlockType, MealzcoreSponsorBlockTypeAttributes, MealzcoreSponsorBlockTypeRelationships, MealzcoreSponsorBlockTypeAttributesCompanion, MealzcoreSponsorBlockTypeRelationshipCompanion, MealzcoreSponsorBlockTypeSerializer, MealzcoreSponsorBlockTypesList, MealzcoreSponsorBlocksRelationshipsCompanion, MealzcoreSponsorBlocksSerializer, MealzcoreSponsorBlocksRelationships, MealzcoreSponsorListRelationshipCompanion, MealzcoreSponsorListSerializer, MealzcoreSponsorRelationshipName, MealzcoreSponsorRelationshipsCompanion, MealzcoreStartTransferResponseCompanion, MealzcoreSuggestionsCriteriaCompanion, MealzcoreSupplierCompanion, MealzcoreSupplierAttributes, MealzcoreSupplierRelationships, MealzcoreSupplierAttributesCompanion, MealzcoreSupplierNotificationWrapperCompanion, MealzcoreSupplierNotificationWrapper, MealzcoreSupplierProduct, MealzcoreTagCompanion, MealzcoreTagAttributes, MealzcoreTagRelationships, MealzcoreTagAttributesCompanion, MealzcoreTagListListSerializer, MealzcoreTagListRelationshipCompanion, MealzcoreBasketEntryFakeFactory, MealzcoreBasketFakeFactory, MealzcoreIngredientFakeFactory, MealzcoreItemFakeFactory, MealzcorePackageFakeFactory, MealzcorePointOfSaleFakeFactory, MealzcoreRecipeFakeFactory, MealzcoreRecipeLikeFakeFactory, MealzcoreRecipeStepFakeFactory, MealzcoreSponsorBlockFakeFactory, MealzcoreSponsorBlockTypeFakeFactory, MealzcoreSponsorFakeFactory, MealzcoreSupplierFakeFactory, MealzcoreTagFakeFactory, MealzcoreCustomDurationSerializer, MealzcoreBasketNotification, MealzcoreBasketNotificationBasketConfirmed, MealzcoreBasketNotificationBasketInit, MealzcoreBasketNotificationBasketReloaded, MealzcoreBasketNotificationBasketReset, MealzcoreBasketNotificationBasketUpdated, MealzcoreBasketNotificationBasketUpdating, MealzcoreBasketNotificationComparatorIsReady, MealzcoreBasketNotificationComparatorIsReset, MealzcoreBasketNotificationEntriesAltered, MealzcoreBasketNotificationEntryAdded, MealzcoreBasketNotificationEntryItemReplaced, MealzcoreBasketNotificationEntryQuantityUpdated, MealzcoreBasketNotificationEntryRemoved, MealzcoreBasketNotificationRecipeCountChanged, MealzcoreBasketNotificationRecipesAdded, MealzcoreBasketNotificationRecipesRemoved, MealzcoreBasketNotificationRecipesUpdated, MealzcoreMealPlannerBasketPreviewNotification, MealzcoreMealPlannerBasketPreviewNotificationRecipeRowLoading, MealzcoreMealPlannerBasketPreviewNotificationRecipeRowReady, MealzcorePointOfSaleNotification, MealzcorePreferencesNotification, MealzcorePreferencesNotificationPreferencesLoaded, MealzcorePreferencesNotificationPreferencesUpdated, MealzcoreBasketEntryNotification, MealzcoreBasketEntryNotificationBasketEntryAdded, MealzcoreBasketEntryNotificationBasketEntryQtyUpdated, MealzcoreBasketEntryNotificationBasketEntryRemoved, MealzcoreBasketEntryNotificationBasketEntryReplaced, MealzcoreBasketEntryNotificationChildReady, MealzcoreBasketEntryNotificationGoToItemSelector, MealzcoreBasketEntryNotificationGoToItemSelectorForRecipe, MealzcoreAbstractNotifier<T1>, MealzcoreToasterNotification, MealzcoreToasterNotificationRecipeAdded, MealzcoreToasterNotificationRecipeLiked, MealzcoreUserNotification, MealzcoreUserNotificationTokenExpired, MealzcoreUserNotificationUserConnected, MealzcoreUserNotificationUserDisconnected, MealzcoreMealzImages, MealzcoreResourcesImageResource, MealzcoreAnalyticsPlausibleProps, MealzcoreAnalyticEvent, MealzcoreAnalyticsCompanion, MealzcoreAnalyticsPlausibleEventCompanion, MealzcoreAnalyticsPlausibleEvent, MealzcoreAnalyticsPlausiblePaths, MealzcoreAnalyticsPlausiblePropsCompanion, MealzcoreAnalyticsInstance, MealzcoreRoute, MealzcoreDialogRoute, MealzcorePageRoute, MealzcoreRouteServiceAction, MealzcoreRouteServiceActionSetDialogRoute, MealzcoreRouteServiceActionSetInitialPageRoute, MealzcoreRouteServiceActionSetPageRoute, MealzcoreRouteServiceEffect, MealzcoreRouteServiceEffectRouteChanged, MealzcoreRouteServiceInstance, MealzcoreRouteServiceState, MealzcoreUserPreferencesCompanion, MealzcoreLikeEffect, MealzcoreLikeEffectDisliked, MealzcoreLikeEffectLiked, MealzcoreLikeStoreInstance, MealzcoreLikeStore, MealzcoreUserState, MealzcoreUserStoreImplCompanion, MealzcoreUserAction, MealzcoreAvailabilityState, MealzcoreBasketAction, MealzcoreBasketActionRefreshBasket, MealzcoreBasketActionRefreshBasketPrice, MealzcoreBasketActionResetBasket, MealzcoreBasketState, MealzcoreBasketComparisonItem, MealzcoreBasketComparator, MealzcoreBasketComparatorData, MealzcoreMealPlannerState, MealzcoreAddRecipesByIdsToMealPlannerUseCaseInput, MealzcoreSetProfilingAllowedUseCaseCompanion, MealzcoreKotlinUnit, MealzcoreSetProfilingAllowedUseCase, MealzcoreEnableRecipeLikeUseCaseCompanion, MealzcoreEnableRecipeLikeUseCase, MealzcoreUpdateUserAuthInfoUseCaseInput, MealzcoreAddRecipeUseCaseInput, MealzcoreUpdateRecipesUseCaseInput, MealzcoreRetailerInput, MealzcoreBasketEntryContractEvent, MealzcoreBasketEntryContractEventAddBasketEntry, MealzcoreBasketEntryContractEventInit, MealzcoreBasketEntryContractEventLockFromParent, MealzcoreBasketEntryContractEventRemoveBasketEntry, MealzcoreBasketEntryContractEventReplaceBasketEntry, MealzcoreBasketEntryContractEventUnLockFromParent, MealzcoreBasketEntryContractEventUpdateBasketEntryQty, MealzcoreBasketEntryContractState, MealzcoreBaseViewModel<Event, State, Effect>, MealzcoreBasketEntryNotifier, MealzcoreBasketEntryContractEffect, MealzcoreBasketEntryViewModel, MealzcoreBasketPreviewContractEvent, MealzcoreBasketPreviewContractEventCloseItemSelector, MealzcoreBasketPreviewContractEventKillJob, MealzcoreBasketPreviewContractEventRemoveRecipe, MealzcoreBasketPreviewContractEventReplaceItem, MealzcoreBasketPreviewContractEventToggleLine, MealzcoreBasketPreviewContractState, MealzcoreBasketPreviewContractEffect, MealzcoreBasketPreviewViewModelLineUpdateState, MealzcoreBasketTagContractEvent, MealzcoreBasketTagContractEventSetRetailerProductId, MealzcoreBasketTagContractState, MealzcoreRouterOutletViewModel, MealzcoreBasketTagContractEffect, MealzcoreCatalogContent, MealzcoreCatalogContractEvent, MealzcoreCatalogContractEventGoBack, MealzcoreCatalogContractEventGoToFavorite, MealzcoreDialogContent, MealzcoreCatalogContractState, MealzcoreFilterViewModelCompanion, MealzcoreFilterContractState, MealzcoreFilterContractEvent, MealzcoreFilterContractEffect, MealzcoreFilterViewModel, MealzcoreCatalogViewModelCompanion, MealzcoreCatalogContractEffect, MealzcoreRecipesPageContractState, MealzcoreRecipesPageContractEvent, MealzcoreRecipesPageContractEffect, MealzcoreDynamicRecipeDetailContractEvent, MealzcoreDynamicRecipeDetailContractEventAddAllRemainingIngredients, MealzcoreDynamicRecipeDetailContractEventReset, MealzcoreDynamicRecipeDetailContractEventSetRecipeId, MealzcoreDynamicRecipeDetailContractEventUpdateGuests, MealzcoreDynamicRecipeDetailContractState, MealzcoreDynamicRecipeDetailFooterViewModel, MealzcoreDynamicRecipeDetailContractEffect, MealzcoreDynamicRecipeDetailFooterContractEvent, MealzcoreDynamicRecipeDetailFooterContractEventLockFromParent, MealzcoreDynamicRecipeDetailFooterContractEventOnTapContinueShopping, MealzcoreDynamicRecipeDetailFooterContractEventSetGuests, MealzcoreDynamicRecipeDetailFooterContractEventSetIngredientsStatus, MealzcoreDynamicRecipeDetailFooterContractEventSetRecipe, MealzcoreDynamicRecipeDetailFooterContractEventUnLockFromParent, MealzcoreIngredientStatus, MealzcoreDynamicRecipeDetailFooterContractState, MealzcoreDynamicRecipeDetailFooterContractEffect, MealzcoreIngredientStatusTypes, MealzcoreFactoryViewModelViewModelContainer<T>, MealzcoreFavoritePageContractEvent, MealzcoreFavoritePageContractEventLoadPage, MealzcoreFavoritePageContractState, MealzcoreFavoritePageViewModelCompanion, MealzcoreFavoritePageContractEffect, MealzcoreFilterContractEffectOnUpdate, MealzcoreFilterContractEventOnCostFilterChanged, MealzcoreFilterContractEventOnDifficultyChanged, MealzcoreFilterContractEventOnTimeFilterChanged, MealzcoreFilterEffect, MealzcoreFilterEffectOnUpdate, MealzcoreFilterInstance, MealzcoreFactoryViewModel<T>, MealzcoreFilterViewModelFactoryCompanion, MealzcoreItemSelectorContractEvent, MealzcoreItemSelectorContractEventInitStandalone, MealzcoreItemSelectorContractEventInitWithBasketEntry, MealzcoreItemSelectorContractEventInitWithIngredientId, MealzcoreItemSelectorContractEventReturnToDetail, MealzcoreItemSelectorContractEventSearch, MealzcoreItemSelectorContractEventSelectItem, MealzcoreItemSelectorContractState, MealzcoreItemSelectorEmptyStates, MealzcoreItemSelectorContractEffect, MealzcoreMealPlannerBasketPreviewContractState, MealzcoreMealPlannerBasketPreviewContractEvent, MealzcoreMealPlannerBasketPreviewContractEffect, MealzcoreDynamicRecipeDetailViewModel, MealzcoreRecipeRowState, MealzcoreMealPlannerFormContractState, MealzcoreMealPlannerFormContractEvent, MealzcoreMealPlannerFormContractEffect, MealzcoreMealPlannerMealsContractState, MealzcoreMealPlannerMealsContractEvent, MealzcoreMealPlannerMealsContractEffect, MealzcoreMealPlannerRecapContractState, MealzcoreMealPlannerRecapContractEvent, MealzcoreMealPlannerRecapContractEffect, MealzcoreRecipesPageViewModel, MealzcoreMyBasketContractState, MealzcoreMyBasketContractEvent, MealzcoreMyBasketContractEffect, MealzcoreMyMealContractState, MealzcoreMyMealContractEvent, MealzcoreMyMealContractEffect, MealzcoreMyMealButtonContractState, MealzcoreMyMealButtonContractEvent, MealzcoreMyMealButtonContractEffect, MealzcoreMyProductsContractState, MealzcoreMyProductsContractEvent, MealzcoreMyProductsContractEffect, MealzcorePreferencesContent, MealzcorePreferencesContractState, MealzcorePreferencesViewModelInstance, MealzcoreSingletonPreferencesViewModelCompanion, MealzcorePreferencesContractEvent, MealzcorePreferencesContractEffect, MealzcorePreferencesSearchContractState, MealzcorePreferencesSearchContractEvent, MealzcorePreferencesSearchContractEffect, MealzcorePricingContractState, MealzcorePricingContractEvent, MealzcorePricingContractEffect, MealzcoreQuantityFormatterDefault, MealzcoreRecipeContractEffect, MealzcoreRecipeContractEffectDisliked, MealzcoreRecipeContractEffectHideCard, MealzcoreRecipeContractEvent, MealzcoreRecipeContractEventError, MealzcoreRecipeContractEventFetchRecipeFromCriteria, MealzcoreRecipeContractEventFetchRecipeFromId, MealzcoreRecipeContractEventGoToDetail, MealzcoreRecipeContractState, MealzcoreRecipeCarouselContractEvent, MealzcoreRecipeCarouselContractEventGetRecipeSuggestionsFromCriteria, MealzcoreRecipeCarouselContractEventGetRecipeSuggestionsFromId, MealzcoreRecipeCarouselContractState, MealzcoreRecipeCarouselContractEffect, MealzcoreRecipeLikeContractState, MealzcoreRecipeLikeContractEvent, MealzcoreRecipeLikeContractEffect, MealzcoreLikeButtonViewModelFactoryCompanion, MealzcoreLikeButtonViewModel, MealzcoreRouterContent, MealzcoreRouterOutletContractEvent, MealzcoreRecipeViewModel, MealzcoreRouterOutletContractEventGoToDetail, MealzcoreRouterOutletContractEventGoToHelper, MealzcoreRouterOutletContractEventGoToItemSelector, MealzcoreRouterOutletContractEventGoToPreview, MealzcoreRouterOutletContractEventGoToSponsor, MealzcoreRouterOutletContractEventOpenDialog, MealzcoreRouterOutletContractEventPrevious, MealzcoreRouterOutletContractState, MealzcoreRouterOutletContractEffect, MealzcoreSponsorDetailsContractState, MealzcoreSponsorDetailsContractEvent, MealzcoreSponsorDetailsContractEffect, MealzcoreSponsorDetailState, MealzcoreStoreLocatorButtonState, MealzcoreOptionalConfigurationBuilder, MealzcoreSdkRequirementBuilder, MealzcoreSubscriptionConfigBuilder, MealzcoreBasketSubscriptionBuilder, MealzcoreKotlinx_serialization_jsonJson, MealzcoreKotlinException, MealzcoreKotlinRuntimeException, MealzcoreKotlinIllegalStateException, MealzcoreKotlinCancellationException, MealzcoreKotlinAbstractCoroutineContextKey<B, E>, MealzcoreKotlinx_serialization_jsonJsonElementCompanion, MealzcoreKotlinx_serialization_coreSerializersModule, MealzcoreKotlinx_serialization_coreSerialKind, UIImage, MealzcoreKotlinx_serialization_jsonJsonDefault, MealzcoreKotlinx_serialization_jsonJsonConfiguration;

@protocol MealzcoreKotlinx_coroutines_coreFlowCollector, MealzcoreKotlinx_coroutines_coreFlow, MealzcoreClosable, MealzcoreKotlinx_coroutines_coreCoroutineScope, MealzcoreKotlinCoroutineContext, MealzcoreNotifier, MealzcoreKotlinx_coroutines_coreDeferred, MealzcoreKotlinComparable, MealzcoreKotlinx_coroutines_coreJob, MealzcoreIExecutorScope, MealzcoreKotlinCoroutineContextKey, MealzcoreKotlinCoroutineContextElement, MealzcoreKotlinContinuation, MealzcoreKotlinContinuationInterceptor, MealzcoreKotlinx_coroutines_coreRunnable, MealzcoreKotlinx_coroutines_coreSharedFlow, MealzcoreKotlinx_coroutines_coreStateFlow, MealzcoreAction, MealzcoreUserStore, MealzcoreRecipeRepository, MealzcoreRecipeDataSource, MealzcoreAnalytics, MealzcoreI18nResource, MealzcoreKotlinx_serialization_coreKSerializer, MealzcoreKotlinKClass, MealzcoreKotlinx_serialization_coreEncoder, MealzcoreKotlinx_serialization_coreSerialDescriptor, MealzcoreKotlinx_serialization_coreSerializationStrategy, MealzcoreKotlinx_serialization_coreDecoder, MealzcoreKotlinx_serialization_coreDeserializationStrategy, MealzcoreKotlinx_coroutines_coreMutableSharedFlow, MealzcoreKotlinx_coroutines_coreCoroutineExceptionHandler, MealzcoreKotlinx_coroutines_coreMutableStateFlow, MealzcoreStore, MealzcoreEffect, MealzcoreState, MealzcoreUserPreferences, MealzcoreBasketPublisher, MealzcoreBasketSubscriber, MealzcoreUseCase, MealzcoreBasketStore, MealzcoreBasketRepository, MealzcoreParameterisedUseCase, MealzcoreSupplierRepository, MealzcoreBasketComparatorStore, MealzcoreItemRepository, MealzcoreUiEffect, MealzcoreUiEvent, MealzcoreUiState, MealzcoreMealPlannerStore, MealzcoreSponsorDetailViewModel, MealzcoreResourcesStringDesc, MealzcoreKotlinx_coroutines_coreSelectClause1, MealzcoreKotlinx_coroutines_coreChildHandle, MealzcoreKotlinx_coroutines_coreChildJob, MealzcoreKotlinx_coroutines_coreDisposableHandle, MealzcoreKotlinSequence, MealzcoreKotlinx_coroutines_coreSelectClause0, MealzcoreKotlinIterator, MealzcoreKotlinKDeclarationContainer, MealzcoreKotlinKAnnotatedElement, MealzcoreKotlinKClassifier, MealzcoreKotlinx_serialization_coreCompositeEncoder, MealzcoreKotlinAnnotation, MealzcoreKotlinx_serialization_coreCompositeDecoder, MealzcoreKotlinx_serialization_coreSerialFormat, MealzcoreKotlinx_serialization_coreStringFormat, MealzcoreKotlinx_coroutines_coreSelectInstance, MealzcoreKotlinx_coroutines_coreSelectClause, MealzcoreKotlinx_coroutines_coreParentJob, MealzcoreKotlinx_serialization_coreSerializersModuleCollector, MealzcoreKotlinx_serialization_jsonJsonNamingStrategy;
...
@property (readonly) MealzcoreMealzPayment *payment __attribute__((swift_name("payment")));
...
- (void)handlePaymentTotalAmount:(double)totalAmount __attribute__((swift_name("handlePayment(totalAmount:)"))) __attribute__((deprecated("handlePayment has been replaced with payment.paymentFinished")));
...
- (void)setLanguageLanguage:(MealzcoreSupportedLanguage *)language __attribute__((swift_name("setLanguage(language:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Mealz.Payment")))
@interface MealzcoreMealzPayment : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)payment __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreMealzPayment *shared __attribute__((swift_name("shared")));
- (void)paymentFinishedTotalAmount:(double)totalAmount totalProductCount:(MealzcoreInt * _Nullable)totalProductCount clientOrderId:(NSString * _Nullable)clientOrderId __attribute__((swift_name("paymentFinished(totalAmount:totalProductCount:clientOrderId:)")));
- (void)paymentStartedTotalAmount:(double)totalAmount totalProductCount:(MealzcoreInt * _Nullable)totalProductCount clientOrderId:(NSString * _Nullable)clientOrderId __attribute__((swift_name("paymentStarted(totalAmount:totalProductCount:clientOrderId:)")));
@end
...
- (void)setRetailerRetailerId:(NSString *)retailerId retailerName:(NSString *)retailerName __attribute__((swift_name("setRetailer(retailerId:retailerName:)")));
- (void)setSignInRedirectionOpenSignIn:(void (^)(void))openSignIn __attribute__((swift_name("setSignInRedirection(openSignIn:)")));
- (void)setStoreIdStoreId:(NSString *)storeId __attribute__((swift_name("setStoreId(storeId:)"))) __attribute__((deprecated("setStoreId is Async which may cause unwanted side effects. Use setStoreIdWithCallBack")));
- (void)setStoreIdWithCallBackStoreId:(NSString *)storeId callBack:(void (^ _Nullable)(void))callBack __attribute__((swift_name("setStoreIdWithCallBack(storeId:callBack:)")));
...
- (void)setStoreWithMealzIdStoreId:(NSString *)storeId __attribute__((swift_name("setStoreWithMealzId(storeId:)"))) __attribute__((deprecated("setStoreWithMealzId is Async which may cause unwanted side effects. Use setStoreWithMealzIdWithCallBack")));
- (void)setStoreWithMealzIdWithCallBackStoreId:(NSString *)storeId callBack:(void (^ _Nullable)(void))callBack __attribute__((swift_name("setStoreWithMealzIdWithCallBack(storeId:callBack:)")));
...
@property (class, readonly) NSArray<MealzcoreOperatingSystem *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) NSArray<MealzcoreComponentUiState *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((swift_name("ParameterisedUseCase")))
@protocol MealzcoreParameterisedUseCase
@required
- (id _Nullable)invokeInput:(id _Nullable)input __attribute__((swift_name("invoke(input:)")));
@end

__attribute__((swift_name("UseCase")))
@protocol MealzcoreUseCase
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRecipePriceRecipeId:(NSString *)recipeId posId:(NSString *)posId priceBook:(NSString * _Nullable)priceBook serves:(int32_t)serves completionHandler:(void (^)(MealzcoreRecipePricing * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRecipePrice(recipeId:posId:priceBook:serves:completionHandler:)")));
...
@property (class, readonly) NSArray<MealzcoreRecipeFilter *> *entries __attribute__((swift_name("entries")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)abortTransferPosId:(NSString *)posId completionHandler:(void (^)(MealzcoreBasket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("abortTransfer(posId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addRecipesToBasketWithIngredientBasketId:(NSString *)basketId recipeInfos:(NSArray<MealzcoreRecipeInfos *> *)recipeInfos completionHandler:(void (^)(MealzcoreBasket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("addRecipesToBasketWithIngredient(basketId:recipeInfos:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addRecipesToBasketWithoutIngredientBasketId:(NSString *)basketId recipeInfos:(NSArray<MealzcoreRecipeInfos *> *)recipeInfos completionHandler:(void (^)(MealzcoreBasket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("addRecipesToBasketWithoutIngredient(basketId:recipeInfos:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)confirmBasketPosId:(NSString *)posId completionHandler:(void (^)(MealzcoreBasket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("confirmBasket(posId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getBasketPricePosId:(NSString *)posId completionHandler:(void (^)(MealzcoreDouble * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getBasketPrice(posId:completionHandler:)")));
...
__attribute__((swift_name("ItemRepository")))
@protocol MealzcoreItemRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchWithIngredientIdIngredientId:(NSString *)ingredientId completionHandler:(void (^)(NSArray<MealzcoreItem *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchWithIngredientId(ingredientId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPriceItemId:(NSString *)itemId posId:(NSString *)posId priceBook:(NSString *)priceBook completionHandler:(void (^)(MealzcoreItemPrice * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPrice(itemId:posId:priceBook:completionHandler:)")));
- (void)resetLocalItemPrice __attribute__((swift_name("resetLocalItemPrice()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)searchSearch:(NSString *)search ingredientId:(NSString *)ingredientId completionHandler:(void (^)(NSArray<MealzcoreItem *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("search(search:ingredientId:completionHandler:)")));
@end

__attribute__((swift_name("ItemSelectorJourney")))
@protocol MealzcoreItemSelectorJourney
@required
- (MealzcoreItemSelectorWithBasketEntryNavigationData *)getItemSelectorWithBasketEntryJourneyBasketEntryId:(NSString *)basketEntryId __attribute__((swift_name("getItemSelectorWithBasketEntryJourney(basketEntryId:)")));
- (MealzcoreItemSelectorWithIngredientNavigationData *)getItemSelectorWithIngredientJourneyIngredientId:(NSString *)ingredientId __attribute__((swift_name("getItemSelectorWithIngredientJourney(ingredientId:)")));
- (void)saveItemSelectorJourneyData:(MealzcoreItemSelectorNavigationData *)data __attribute__((swift_name("saveItemSelectorJourney(data:)")));
@end

__attribute__((swift_name("PointOfSaleRepository")))
@protocol MealzcorePointOfSaleRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPosFromExtIdExtId:(NSString *)extId supplierId:(NSString * _Nullable)supplierId completionHandler:(void (^)(MealzcorePointOfSale * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getPosFromExtId(extId:supplierId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPosFromIdMealzPosId:(NSString *)mealzPosId completionHandler:(void (^)(MealzcorePointOfSale * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPosFromId(mealzPosId:completionHandler:)")));
- (void)setStoreMealzPosId:(NSString * _Nullable)mealzPosId posName:(NSString * _Nullable)posName externalPosId:(NSString * _Nullable)externalPosId __attribute__((swift_name("setStore(mealzPosId:posName:externalPosId:)")));
@property void (^redirectToStoreLocator)(void) __attribute__((swift_name("redirectToStoreLocator")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PointOfSaleRepositoryCompanion")))
@interface MealzcorePointOfSaleRepositoryCompanion : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcorePointOfSaleRepositoryCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) BOOL isPointOfSaleSet __attribute__((swift_name("isPointOfSaleSet")));
@property NSString * _Nullable pointOfSaleExternalId __attribute__((swift_name("pointOfSaleExternalId")));
@property NSString * _Nullable pointOfSaleMealzId __attribute__((swift_name("pointOfSaleMealzId")));
@property NSString * _Nullable pointOfSaleName __attribute__((swift_name("pointOfSaleName")));
@end
...
@protocol MealzcoreRecipeRepository
@required
...
*/
- (void)getRecipesMaxCountForBudgetConstraintPointOfSale:(NSString *)pointOfSale budget:(int32_t)budget guestCount:(int32_t)guestCount completionHandler:(void (^)(MealzcoreInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRecipesMaxCountForBudgetConstraint(pointOfSale:budget:guestCount:completionHandler:)")));
- (void)resetRecipePricing __attribute__((swift_name("resetRecipePricing()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeRepositoryImp")))
@interface MealzcoreRecipeRepositoryImp : MealzcoreBase <MealzcoreRecipeRepository>
...
@property (class, readonly) NSArray<MealzcoreRecipeSort *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *sortName __attribute__((swift_name("sortName")));
@end

__attribute__((swift_name("RetailerRepository")))
@protocol MealzcoreRetailerRepository
@required
- (void)setRetailerRetailerId:(NSString * _Nullable)retailerId retailerName:(NSString * _Nullable)retailerName __attribute__((swift_name("setRetailer(retailerId:retailerName:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RetailerRepositoryCompanion")))
@interface MealzcoreRetailerRepositoryCompanion : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreRetailerRepositoryCompanion *shared __attribute__((swift_name("shared")));
@property NSString * _Nullable retailerId __attribute__((swift_name("retailerId")));
@property NSString * _Nullable retailerName __attribute__((swift_name("retailerName")));
@end
...
@protocol MealzcoreUserRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAuthlessUserWithCompletionHandler:(void (^)(MealzcoreAuthLessUser * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getAuthlessUser(completionHandler:)")));
@end
...
@property (readonly) id<MealzcoreAnalytics> analyticsService __attribute__((swift_name("analyticsService")));
...
@property (class, readonly) NSArray<MealzcoreLogHandlerLogLevels *> *entries __attribute__((swift_name("entries")));
@end
...
@property (readonly) MealzcoreBasketI18N *basket __attribute__((swift_name("basket")));
@property (readonly) MealzcoreBudgetI18N *budget __attribute__((swift_name("budget")));
@property (readonly) MealzcoreCatalogI18N *catalog __attribute__((swift_name("catalog")));
@property (readonly) MealzcoreCounterI18N *counter __attribute__((swift_name("counter")));
@property (readonly) MealzcoreErrorI18N *error __attribute__((swift_name("error")));
@property (readonly) MealzcoreFavoritesI18N *favorites __attribute__((swift_name("favorites")));
@property (readonly) MealzcoreFiltersI18N *filters __attribute__((swift_name("filters")));
@property (readonly) MealzcoreIngredientI18N *ingredient __attribute__((swift_name("ingredient")));
@property (readonly) MealzcoreItemSelectorI18N *itemSelector __attribute__((swift_name("itemSelector")));
@property (readonly) MealzcoreMyBasketI18N *myBasket __attribute__((swift_name("myBasket")));
@property (readonly) MealzcoreMyMealsI18N *myMeals __attribute__((swift_name("myMeals")));
@property (readonly) MealzcoreMyProductsI18N *myProducts __attribute__((swift_name("myProducts")));
@property (readonly) MealzcoreMyProductsProductI18N *myProductsProduct __attribute__((swift_name("myProductsProduct")));
@property (readonly) MealzcorePreferencesI18N *preferences __attribute__((swift_name("preferences")));
@property (readonly) MealzcorePriceI18N *price __attribute__((swift_name("price")));
@property (readonly) MealzcoreRecipeI18N *recipe __attribute__((swift_name("recipe")));
@property (readonly) MealzcoreRecipeDetailsI18N *recipeDetails __attribute__((swift_name("recipeDetails")));
@property (readonly) MealzcoreRecipeDetailsProductI18N *recipeDetailsProduct __attribute__((swift_name("recipeDetailsProduct")));
@property (readonly) MealzcoreSponsorBannerI18N *sponsorBanner __attribute__((swift_name("sponsorBanner")));
@property (readonly) MealzcoreSponsorDetailI18N *sponsorDetail __attribute__((swift_name("sponsorDetail")));
@property (readonly) MealzcoreStoreLocatorButtonI18N *storeLocatorButton __attribute__((swift_name("storeLocatorButton")));
@property (readonly) MealzcoreTagI18N *tag __attribute__((swift_name("tag")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketI18N")))
@interface MealzcoreBasketI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)basketI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBasketI18N *shared __attribute__((swift_name("shared")));
- (MealzcoreI18n *)articlesNumberOfProducts:(int32_t)numberOfProducts __attribute__((swift_name("articles(numberOfProducts:)")));
- (MealzcoreI18n *)basketTranserToRetailerName:(NSString *)retailerName __attribute__((swift_name("basketTranserTo(retailerName:)")));
- (MealzcoreI18n *)basketTranserToQuestionRetailerName:(NSString *)retailerName __attribute__((swift_name("basketTranserToQuestion(retailerName:)")));
...
@property (readonly) MealzcoreI18n *basketTranser __attribute__((swift_name("basketTranser")));
@property (readonly) MealzcoreI18n *basketTranserAbort __attribute__((swift_name("basketTranserAbort")));
@property (readonly) MealzcoreI18n *basketTranserClose __attribute__((swift_name("basketTranserClose")));
@property (readonly) MealzcoreI18n *basketTranserContinue __attribute__((swift_name("basketTranserContinue")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BudgetI18N")))
@interface MealzcoreBudgetI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)budgetI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBudgetI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogI18N")))
@interface MealzcoreCatalogI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)catalogI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreCatalogI18N *shared __attribute__((swift_name("shared")));
...
@property (readonly) MealzcoreI18n *preferencesTitle __attribute__((swift_name("preferencesTitle")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CounterI18N")))
@interface MealzcoreCounterI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)counterI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreCounterI18N *shared __attribute__((swift_name("shared")));
@property (readonly) MealzcoreI18n *persons __attribute__((swift_name("persons")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ErrorI18N")))
@interface MealzcoreErrorI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)errorI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreErrorI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FavoritesI18N")))
@interface MealzcoreFavoritesI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)favoritesI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreFavoritesI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FiltersI18N")))
@interface MealzcoreFiltersI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)filtersI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreFiltersI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IngredientI18N")))
@interface MealzcoreIngredientI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)ingredientI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreIngredientI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemSelectorI18N")))
@interface MealzcoreItemSelectorI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)itemSelectorI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreItemSelectorI18N *shared __attribute__((swift_name("shared")));
...
@property (readonly) MealzcoreI18n *headerTitleAddProduct __attribute__((swift_name("headerTitleAddProduct")));
...
@property (readonly) MealzcoreI18n *searchProductToAdd __attribute__((swift_name("searchProductToAdd")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MyBasketI18N")))
@interface MealzcoreMyBasketI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)myBasketI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreMyBasketI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MyMealsI18N")))
@interface MealzcoreMyMealsI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)myMealsI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreMyMealsI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MyProductsI18N")))
@interface MealzcoreMyProductsI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)myProductsI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreMyProductsI18N *shared __attribute__((swift_name("shared")));
@property (readonly) MealzcoreI18n *replace __attribute__((swift_name("replace")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MyProductsProductI18N")))
@interface MealzcoreMyProductsProductI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)myProductsProductI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreMyProductsProductI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PreferencesI18N")))
@interface MealzcorePreferencesI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)preferencesI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcorePreferencesI18N *shared __attribute__((swift_name("shared")));
@property (readonly) MealzcoreI18n *addTag __attribute__((swift_name("addTag")));
@property (readonly) MealzcoreI18n *apply __attribute__((swift_name("apply")));
...
@property (readonly) MealzcoreI18n *reset __attribute__((swift_name("reset")));
@property (readonly) MealzcoreI18n *searchPlaceholder __attribute__((swift_name("searchPlaceholder")));
@property (readonly) MealzcoreI18n *searchTitle __attribute__((swift_name("searchTitle")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PriceI18N")))
@interface MealzcorePriceI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)priceI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcorePriceI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeDetailsI18N")))
@interface MealzcoreRecipeDetailsI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)recipeDetailsI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreRecipeDetailsI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeDetailsProductI18N")))
@interface MealzcoreRecipeDetailsProductI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)recipeDetailsProductI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreRecipeDetailsProductI18N *shared __attribute__((swift_name("shared")));
- (MealzcoreI18n *)productsSharedRecipeNumberOfProducts:(int32_t)numberOfProducts __attribute__((swift_name("productsSharedRecipe(numberOfProducts:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeI18N")))
@interface MealzcoreRecipeI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)recipeI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreRecipeI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SponsorBannerI18N")))
@interface MealzcoreSponsorBannerI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)sponsorBannerI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreSponsorBannerI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SponsorDetailI18N")))
@interface MealzcoreSponsorDetailI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)sponsorDetailI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreSponsorDetailI18N *shared __attribute__((swift_name("shared")));
@property (readonly) MealzcoreI18n *emptyCta __attribute__((swift_name("emptyCta")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StoreLocatorButtonI18N")))
@interface MealzcoreStoreLocatorButtonI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)storeLocatorButtonI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreStoreLocatorButtonI18N *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TagI18N")))
@interface MealzcoreTagI18N : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)tagI18N __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreTagI18N *shared __attribute__((swift_name("shared")));
...
- (instancetype)initWithId:(NSString *)id deltaQty:(int32_t)deltaQty currentQty:(int32_t)currentQty __attribute__((swift_name("init(id:deltaQty:currentQty:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreAlterQuantityBasketEntry *)doCopyId:(NSString *)id deltaQty:(int32_t)deltaQty currentQty:(int32_t)currentQty __attribute__((swift_name("doCopy(id:deltaQty:currentQty:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t currentQty __attribute__((swift_name("currentQty")));
...
@property (class, readonly) NSArray<MealzcoreAuthorization *> *entries __attribute__((swift_name("entries")));
...
- (instancetype)initWithStatus:(MealzcoreBasketStatus *)status recipesInfos:(NSMutableArray<MealzcoreRecipeInfos *> *)recipesInfos confirmed:(MealzcoreBoolean * _Nullable)confirmed totalPrice:(float)totalPrice token:(NSString * _Nullable)token priceBookKey:(NSString * _Nullable)priceBookKey __attribute__((swift_name("init(status:recipesInfos:confirmed:totalPrice:token:priceBookKey:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MealzcoreBasketAttributesCompanion *companion __attribute__((swift_name("companion")));
- (MealzcoreBasketAttributes *)doCopyStatus:(MealzcoreBasketStatus *)status recipesInfos:(NSMutableArray<MealzcoreRecipeInfos *> *)recipesInfos confirmed:(MealzcoreBoolean * _Nullable)confirmed totalPrice:(float)totalPrice token:(NSString * _Nullable)token priceBookKey:(NSString * _Nullable)priceBookKey __attribute__((swift_name("doCopy(status:recipesInfos:confirmed:totalPrice:token:priceBookKey:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) MealzcoreBasketStatus *status __attribute__((swift_name("status")));
@property (readonly) NSString * _Nullable token __attribute__((swift_name("token")));
@property (readonly) float totalPrice __attribute__((swift_name("totalPrice"))) __attribute__((deprecated("totalPrice has been replaced with totalPrice stored in the BasketRepository")));
@end
...
@property (readonly) BOOL isInCustomerBasket __attribute__((swift_name("isInCustomerBasket")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPrice")))
@interface MealzcoreBasketPrice : MealzcoreBase
- (instancetype)initWithTotalPrice:(double)totalPrice __attribute__((swift_name("init(totalPrice:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MealzcoreBasketPriceCompanion *companion __attribute__((swift_name("companion")));
- (MealzcoreBasketPrice *)doCopyTotalPrice:(double)totalPrice __attribute__((swift_name("doCopy(totalPrice:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPrice.Companion")))
@interface MealzcoreBasketPriceCompanion : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBasketPriceCompanion *shared __attribute__((swift_name("shared")));
- (id<MealzcoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
/**
 * @note annotations
 *   kotlinx.serialization.Serializable(with=NormalClass(value=ai/mealz/core/model/BasketStatusSerializer))
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketStatus")))
@interface MealzcoreBasketStatus : MealzcoreKotlinEnum<MealzcoreBasketStatus *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) MealzcoreBasketStatusCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) MealzcoreBasketStatus *initial __attribute__((swift_name("initial")));
@property (class, readonly) MealzcoreBasketStatus *transferring __attribute__((swift_name("transferring")));
@property (class, readonly) MealzcoreBasketStatus *transferred __attribute__((swift_name("transferred")));
@property (class, readonly) MealzcoreBasketStatus *confirmed __attribute__((swift_name("confirmed")));
+ (MealzcoreKotlinArray<MealzcoreBasketStatus *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<MealzcoreBasketStatus *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *value __attribute__((swift_name("value")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketStatus.Companion")))
@interface MealzcoreBasketStatusCompanion : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBasketStatusCompanion *shared __attribute__((swift_name("shared")));
- (id<MealzcoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (id<MealzcoreKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(MealzcoreKotlinArray<id<MealzcoreKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketStatusSerializer")))
@interface MealzcoreBasketStatusSerializer : MealzcoreBase <MealzcoreKotlinx_serialization_coreKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)basketStatusSerializer __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBasketStatusSerializer *shared __attribute__((swift_name("shared")));
- (MealzcoreBasketStatus *)deserializeDecoder:(id<MealzcoreKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<MealzcoreKotlinx_serialization_coreEncoder>)encoder value:(MealzcoreBasketStatus *)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<MealzcoreKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end
...
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *pricePerUnitOfMeasurementAsString __attribute__((swift_name("pricePerUnitOfMeasurementAsString")));
...
- (instancetype)initWithExtId:(NSString * _Nullable)extId name:(NSString *)name itemDescription:(NSString * _Nullable)itemDescription brand:(NSString * _Nullable)brand image:(NSString * _Nullable)image unitPrice:(MealzcoreDouble * _Nullable)unitPrice pricePerUnitOfMeasurement:(MealzcoreDouble * _Nullable)pricePerUnitOfMeasurement unitOfMeasurement:(NSString * _Nullable)unitOfMeasurement capacityUnit:(NSString * _Nullable)capacityUnit capacityVolume:(NSString * _Nullable)capacityVolume capacityFactor:(MealzcoreInt * _Nullable)capacityFactor ean:(NSString *)ean variableCapacity:(BOOL)variableCapacity __attribute__((swift_name("init(extId:name:itemDescription:brand:image:unitPrice:pricePerUnitOfMeasurement:unitOfMeasurement:capacityUnit:capacityVolume:capacityFactor:ean:variableCapacity:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MealzcoreItemAttributesCompanion *companion __attribute__((swift_name("companion")));
- (MealzcoreItemAttributes *)doCopyExtId:(NSString * _Nullable)extId name:(NSString *)name itemDescription:(NSString * _Nullable)itemDescription brand:(NSString * _Nullable)brand image:(NSString * _Nullable)image unitPrice:(MealzcoreDouble * _Nullable)unitPrice pricePerUnitOfMeasurement:(MealzcoreDouble * _Nullable)pricePerUnitOfMeasurement unitOfMeasurement:(NSString * _Nullable)unitOfMeasurement capacityUnit:(NSString * _Nullable)capacityUnit capacityVolume:(NSString * _Nullable)capacityVolume capacityFactor:(MealzcoreInt * _Nullable)capacityFactor ean:(NSString *)ean variableCapacity:(BOOL)variableCapacity __attribute__((swift_name("doCopy(extId:name:itemDescription:brand:image:unitPrice:pricePerUnitOfMeasurement:unitOfMeasurement:capacityUnit:capacityVolume:capacityFactor:ean:variableCapacity:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable unitOfMeasurement __attribute__((swift_name("unitOfMeasurement")));
@property (readonly) MealzcoreDouble * _Nullable unitPrice __attribute__((swift_name("unitPrice")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemPrice")))
@interface MealzcoreItemPrice : MealzcoreBase
- (instancetype)initWithUnitPrice:(double)unitPrice pricePerUnitOfMeasurement:(MealzcoreDouble * _Nullable)pricePerUnitOfMeasurement unitOfMeasurement:(NSString * _Nullable)unitOfMeasurement __attribute__((swift_name("init(unitPrice:pricePerUnitOfMeasurement:unitOfMeasurement:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MealzcoreItemPriceCompanion *companion __attribute__((swift_name("companion")));
- (MealzcoreItemPrice *)doCopyUnitPrice:(double)unitPrice pricePerUnitOfMeasurement:(MealzcoreDouble * _Nullable)pricePerUnitOfMeasurement unitOfMeasurement:(NSString * _Nullable)unitOfMeasurement __attribute__((swift_name("doCopy(unitPrice:pricePerUnitOfMeasurement:unitOfMeasurement:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreDouble * _Nullable pricePerUnitOfMeasurement __attribute__((swift_name("pricePerUnitOfMeasurement")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemPrice.Companion")))
@interface MealzcoreItemPriceCompanion : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreItemPriceCompanion *shared __attribute__((swift_name("shared")));
- (id<MealzcoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSDictionary<NSString *, NSString *> *ingredientsMap __attribute__((swift_name("ingredientsMap")));
...
@property (class, readonly) NSArray<MealzcoreRecipeDifficulty *> *entries __attribute__((swift_name("entries")));
...
@property (class, readonly) NSArray<MealzcoreSponsorBlockRelationshipName *> *entries __attribute__((swift_name("entries")));
...
@property (class, readonly) NSArray<MealzcoreSponsorBlockTypesList *> *entries __attribute__((swift_name("entries")));
@end
...
@property (class, readonly) NSArray<MealzcoreSponsorRelationshipName *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *relationshipName __attribute__((swift_name("relationshipName")));
@end
...
@property (class, readonly) NSArray<MealzcoreTagTypes *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketEntryFakeFactory")))
@interface MealzcoreBasketEntryFakeFactory : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)basketEntryFakeFactory __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBasketEntryFakeFactory *shared __attribute__((swift_name("shared")));
- (MealzcoreBasketEntry *)createId:(NSString *)id attributes:(MealzcoreBasketEntryAttributes * _Nullable)attributes relationships:(MealzcoreBasketEntryRelationships * _Nullable)relationships __attribute__((swift_name("create(id:attributes:relationships:)")));
- (MealzcoreBasketEntryAttributes *)createAttributesSelectedItemId:(MealzcoreInt * _Nullable)selectedItemId quantity:(MealzcoreInt * _Nullable)quantity recipeIds:(NSArray<MealzcoreInt *> * _Nullable)recipeIds status:(NSString *)status basketEntriesItems:(NSArray<MealzcoreBasketEntriesItem *> * _Nullable)basketEntriesItems name:(NSString *)name __attribute__((swift_name("createAttributes(selectedItemId:quantity:recipeIds:status:basketEntriesItems:name:)")));
- (MealzcoreBasketEntry *)createBasketEntryWithSelectedIdSelectedItemId:(int32_t)selectedItemId itemPrice:(MealzcoreItemPrice * _Nullable)itemPrice recipeId:(MealzcoreInt * _Nullable)recipeId status:(NSString *)status __attribute__((swift_name("createBasketEntryWithSelectedId(selectedItemId:itemPrice:recipeId:status:)")));
- (MealzcoreBasketEntryRelationships *)createRelationshipsItems:(NSArray<MealzcoreItem *> * _Nullable)items selectedItem:(MealzcoreItem * _Nullable)selectedItem __attribute__((swift_name("createRelationships(items:selectedItem:)")));
...
- (MealzcoreBasket *)createBasketId:(NSString *)id attributes:(MealzcoreBasketAttributes * _Nullable)attributes relationships:(MealzcoreBasketRelationships * _Nullable)relationships recipes:(NSArray<MealzcoreRecipe *> *)recipes __attribute__((swift_name("createBasket(id:attributes:relationships:recipes:)")));
- (MealzcoreBasketAttributes *)createBasketAttributesRecipeInfos:(NSMutableArray<MealzcoreRecipeInfos *> *)recipeInfos token:(NSString * _Nullable)token __attribute__((swift_name("createBasketAttributes(recipeInfos:token:)")));
- (MealzcoreBasketRelationships *)createBasketRelationshipsBasketEntries:(NSArray<MealzcoreBasketEntry *> * _Nullable)basketEntries __attribute__((swift_name("createBasketRelationships(basketEntries:)")));
- (MealzcoreBasket *)createBasketWithRecipeRecipeId:(NSString *)recipeId guests:(int32_t)guests __attribute__((swift_name("createBasketWithRecipe(recipeId:guests:)")));
- (MealzcoreBasket *)createBasketWithRecipeAndEntriesRecipeId:(NSString *)recipeId guests:(int32_t)guests basketEntries:(NSArray<MealzcoreBasketEntry *> *)basketEntries __attribute__((swift_name("createBasketWithRecipeAndEntries(recipeId:guests:basketEntries:)")));
...
- (MealzcoreItemAttributes *)createAttributesName:(NSString *)name unitPrice:(MealzcoreDouble * _Nullable)unitPrice __attribute__((swift_name("createAttributes(name:unitPrice:)")));
@property (readonly) NSString *FAKE_ID __attribute__((swift_name("FAKE_ID")));
...
- (MealzcoreRecipe *)createIdAsInt:(int32_t)idAsInt attributes:(MealzcoreRecipeAttributes * _Nullable)attributes relationships:(MealzcoreRecipeRelationships * _Nullable)relationships __attribute__((swift_name("create(idAsInt:attributes:relationships:)")));
...
__attribute__((swift_name("ItemSelectorNavigationData")))
@interface MealzcoreItemSelectorNavigationData : MealzcoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) MealzcoreBasketEntry *basketEntry __attribute__((swift_name("basketEntry")));
@property (readonly) void (^updateProductFromItemSelector)(MealzcoreItem *) __attribute__((swift_name("updateProductFromItemSelector")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemSelectorWithBasketEntryNavigationData")))
@interface MealzcoreItemSelectorWithBasketEntryNavigationData : MealzcoreItemSelectorNavigationData
- (instancetype)initWithBasketEntry:(MealzcoreBasketEntry *)basketEntry updateProductFromItemSelector:(void (^)(MealzcoreItem *))updateProductFromItemSelector __attribute__((swift_name("init(basketEntry:updateProductFromItemSelector:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MealzcoreItemSelectorWithBasketEntryNavigationData *)doCopyBasketEntry:(MealzcoreBasketEntry *)basketEntry updateProductFromItemSelector:(void (^)(MealzcoreItem *))updateProductFromItemSelector __attribute__((swift_name("doCopy(basketEntry:updateProductFromItemSelector:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreBasketEntry *basketEntry __attribute__((swift_name("basketEntry")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemSelectorWithIngredientNavigationData")))
@interface MealzcoreItemSelectorWithIngredientNavigationData : MealzcoreItemSelectorNavigationData
- (instancetype)initWithRecipeId:(NSString *)recipeId ingredientId:(NSString *)ingredientId ingredientName:(NSString *)ingredientName ingredientQuantity:(int32_t)ingredientQuantity ingredientUnit:(NSString *)ingredientUnit guestCount:(int32_t)guestCount defaultRecipeGuest:(int32_t)defaultRecipeGuest basketEntry:(MealzcoreBasketEntry *)basketEntry isASubstitution:(BOOL)isASubstitution updateProductFromItemSelector:(void (^)(MealzcoreItem *))updateProductFromItemSelector __attribute__((swift_name("init(recipeId:ingredientId:ingredientName:ingredientQuantity:ingredientUnit:guestCount:defaultRecipeGuest:basketEntry:isASubstitution:updateProductFromItemSelector:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MealzcoreItemSelectorWithIngredientNavigationData *)doCopyRecipeId:(NSString *)recipeId ingredientId:(NSString *)ingredientId ingredientName:(NSString *)ingredientName ingredientQuantity:(int32_t)ingredientQuantity ingredientUnit:(NSString *)ingredientUnit guestCount:(int32_t)guestCount defaultRecipeGuest:(int32_t)defaultRecipeGuest basketEntry:(MealzcoreBasketEntry *)basketEntry isASubstitution:(BOOL)isASubstitution updateProductFromItemSelector:(void (^)(MealzcoreItem *))updateProductFromItemSelector __attribute__((swift_name("doCopy(recipeId:ingredientId:ingredientName:ingredientQuantity:ingredientUnit:guestCount:defaultRecipeGuest:basketEntry:isASubstitution:updateProductFromItemSelector:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreBasketEntry *basketEntry __attribute__((swift_name("basketEntry")));
...
@property (readonly) BOOL isASubstitution __attribute__((swift_name("isASubstitution")));
@property (readonly) NSString *recipeId __attribute__((swift_name("recipeId")));
@property (readonly) void (^updateProductFromItemSelector)(MealzcoreItem *) __attribute__((swift_name("updateProductFromItemSelector")));
@end
...
@protocol MealzcoreAnalytics
@required
- (void)emitEventEvent:(MealzcoreAnalyticEvent *)event __attribute__((swift_name("emitEvent(event:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsCompanion")))
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsPlausibleEvent")))
@interface MealzcoreAnalyticsPlausibleEvent : MealzcoreBase
- (instancetype)initWithName:(NSString *)name url:(NSString *)url domain:(NSString *)domain props:(MealzcoreAnalyticsPlausibleProps *)props __attribute__((swift_name("init(name:url:domain:props:)"))) __attribute__((objc_designated_initializer));
...
- (MealzcoreAnalyticsPlausibleEvent *)doCopyName:(NSString *)name url:(NSString *)url domain:(NSString *)domain props:(MealzcoreAnalyticsPlausibleProps *)props __attribute__((swift_name("doCopy(name:url:domain:props:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsPlausibleEvent.Companion")))
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsPlausiblePaths")))
...
@property (class, readonly) NSArray<MealzcoreAnalyticsPlausiblePaths *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *path __attribute__((swift_name("path")));
@end
...
@property (readonly) MealzcoreInt * _Nullable miam_products __attribute__((swift_name("miam_products")));
...
@property (readonly) MealzcoreInt * _Nullable product_quantity __attribute__((swift_name("product_quantity")));
...
@property (readonly) MealzcoreInt * _Nullable total_products __attribute__((swift_name("total_products")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsPlausibleProps.Companion")))
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsImp")))
@interface MealzcoreAnalyticsImp : MealzcoreBase <MealzcoreAnalytics>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)emitEventEvent:(MealzcoreAnalyticEvent *)event __attribute__((swift_name("emitEvent(event:)")));
- (void)doInitSupplierOrigin:(NSString *)supplierOrigin __attribute__((swift_name("doInit(supplierOrigin:)")));
...
@protocol MealzcoreUserPreferences
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserPreferencesCompanion")))
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserPreferencesImp")))
@interface MealzcoreUserPreferencesImp : MealzcoreBase <MealzcoreUserPreferences>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (MealzcoreDouble * _Nullable)getDoubleOrNullKey:(NSString *)key __attribute__((swift_name("getDoubleOrNull(key:)")));
- (MealzcoreInt * _Nullable)getIntOrNullKey:(NSString *)key __attribute__((swift_name("getIntOrNull(key:)")));
...
@interface MealzcoreEnvironment : MealzcoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property BOOL allowsSponsoredProducts __attribute__((swift_name("allowsSponsoredProducts")));
@property MealzcoreKMMContext * _Nullable context __attribute__((swift_name("context")));
@property NSString *environmentUrl __attribute__((swift_name("environmentUrl")));
@property (readonly) BOOL isSupplierOnly __attribute__((swift_name("isSupplierOnly")));
@property NSString *miamOrigin __attribute__((swift_name("miamOrigin")));
@property NSString *origin __attribute__((swift_name("origin")));
@property NSString *priceBook __attribute__((swift_name("priceBook")));
@property NSString * _Nullable providerId __attribute__((swift_name("providerId")));
@property NSString * _Nullable supplierId __attribute__((swift_name("supplierId")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketAction.RefreshBasketPrice")))
@interface MealzcoreBasketActionRefreshBasketPrice : MealzcoreBasketAction
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)refreshBasketPrice __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreBasketActionRefreshBasketPrice *shared __attribute__((swift_name("shared")));
@end
...
- (NSArray<MealzcoreBasketEntry *> *)getBasketEntries __attribute__((swift_name("getBasketEntries()")));
...
@property (readonly) double basketTotalPrice __attribute__((swift_name("basketTotalPrice")));
@property (readonly) NSArray<MealzcoreBasketEntry *> *entries __attribute__((swift_name("entries")));
@end
...
__attribute__((swift_name("BasketComparatorStore")))
@protocol MealzcoreBasketComparatorStore
@required
- (void)basketChangeSdkActiveBasket:(NSArray<MealzcoreBasketEntry *> *)sdkActiveBasket __attribute__((swift_name("basketChange(sdkActiveBasket:)")));
- (int32_t)getNumberOfProductsInCustomerBasket __attribute__((swift_name("getNumberOfProductsInCustomerBasket()")));
- (void)handleSdkBasketNotificationNotification:(MealzcoreBasketNotification *)notification __attribute__((swift_name("handleSdkBasketNotification(notification:)")));
- (void)doInitFirstSdkBasketSdkActiveBasket:(NSArray<MealzcoreBasketEntry *> *)sdkActiveBasket __attribute__((swift_name("doInitFirstSdkBasket(sdkActiveBasket:)")));
- (void)doInitFirstSupplierBasketSupplierBasket:(NSArray<MealzcoreSupplierProduct *> *)supplierBasket __attribute__((swift_name("doInitFirstSupplierBasket(supplierBasket:)")));
- (void)doInitIfPossible __attribute__((swift_name("doInitIfPossible()")));
- (void)processSupplierEventRetailerBasket:(NSArray<MealzcoreSupplierProduct *> *)retailerBasket __attribute__((swift_name("processSupplierEvent(retailerBasket:)")));
- (void)reset __attribute__((swift_name("reset()")));
- (void)sendUpdateToSdkEntriesToRemove:(NSArray<MealzcoreAlterQuantityBasketEntry *> *)entriesToRemove __attribute__((swift_name("sendUpdateToSdk(entriesToRemove:)")));
- (void)sendUpdateToSupplierItemsToAdd:(NSArray<MealzcoreSupplierProduct *> *)itemsToAdd __attribute__((swift_name("sendUpdateToSupplier(itemsToAdd:)")));
@end
...
@protocol MealzcoreMealPlannerStore
@required
- (void)setRecipeIdsRecipesId:(NSArray<id> *)recipesId __attribute__((swift_name("setRecipeIds(recipesId:)")));
- (void)setTotalPricePrice:(double)price __attribute__((swift_name("setTotalPrice(price:)")));
@property (readonly) id<MealzcoreKotlinx_coroutines_coreStateFlow> state __attribute__((swift_name("state")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AbortBasketUseCase")))
@interface MealzcoreAbortBasketUseCase : MealzcoreBase <MealzcoreUseCase, MealzcoreKotlinx_coroutines_coreCoroutineScope>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfirmBasketUseCase")))
@interface MealzcoreConfirmBasketUseCase : MealzcoreBase <MealzcoreParameterisedUseCase, MealzcoreKotlinx_coroutines_coreCoroutineScope>
- (instancetype)initWithBasketRepository:(id<MealzcoreBasketRepository>)basketRepository basketStore:(id<MealzcoreBasketStore>)basketStore analytics:(id<MealzcoreAnalytics>)analytics supplierRepository:(id<MealzcoreSupplierRepository>)supplierRepository __attribute__((swift_name("init(basketRepository:basketStore:analytics:supplierRepository:)"))) __attribute__((objc_designated_initializer));
- (id<MealzcoreKotlinx_coroutines_coreJob>)invokeInput:(MealzcoreAnalyticsPlausibleProps *)input __attribute__((swift_name("invoke(input:)")));
@property (readonly) id<MealzcoreKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TransferAuthlessBasketUseCase")))
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetNumberOfProductsInCustomerBasketUseCase")))
@interface MealzcoreGetNumberOfProductsInCustomerBasketUseCase : MealzcoreBase <MealzcoreUseCase, MealzcoreKotlinx_coroutines_coreCoroutineScope>
- (instancetype)initWithBasketComparatorStore:(id<MealzcoreBasketComparatorStore>)basketComparatorStore __attribute__((swift_name("init(basketComparatorStore:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreInt *)invoke __attribute__((swift_name("invoke()")));
@property (readonly) id<MealzcoreKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SetBasketEntrySelectedItemPriceUseCase")))
@interface MealzcoreSetBasketEntrySelectedItemPriceUseCase : MealzcoreBase <MealzcoreParameterisedUseCase, MealzcoreKotlinx_coroutines_coreCoroutineScope>
- (instancetype)initWithItemRepositoryImp:(id<MealzcoreItemRepository>)itemRepositoryImp __attribute__((swift_name("init(itemRepositoryImp:)"))) __attribute__((objc_designated_initializer));
- (id<MealzcoreKotlinx_coroutines_coreDeferred>)invokeInput:(MealzcoreBasketEntry *)input __attribute__((swift_name("invoke(input:)")));
@property (readonly) id<MealzcoreKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end
...
@interface MealzcoreSetProfilingAllowedUseCase : MealzcoreBase <MealzcoreParameterisedUseCase>
- (instancetype)initWithUserStore:(id<MealzcoreUserStore>)userStore __attribute__((swift_name("init(userStore:)"))) __attribute__((objc_designated_initializer));
...
- (MealzcoreKotlinUnit *)invokeInput:(MealzcoreBoolean *)input __attribute__((swift_name("invoke(input:)")));
@end
...
@interface MealzcoreGetIsAnonymousModeEnableUseCase : MealzcoreBase <MealzcoreUseCase>
- (instancetype)initWithUserStore:(id<MealzcoreUserStore>)userStore __attribute__((swift_name("init(userStore:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreBoolean *)invoke __attribute__((swift_name("invoke()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SetLanguageUseCase")))
@interface MealzcoreSetLanguageUseCase : MealzcoreBase <MealzcoreParameterisedUseCase>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (MealzcoreKotlinUnit *)invokeInput:(MealzcoreSupportedLanguage *)input __attribute__((swift_name("invoke(input:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SupportedLanguage")))
@interface MealzcoreSupportedLanguage : MealzcoreKotlinEnum<MealzcoreSupportedLanguage *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) MealzcoreSupportedLanguage *english __attribute__((swift_name("english")));
@property (class, readonly) MealzcoreSupportedLanguage *french __attribute__((swift_name("french")));
+ (MealzcoreKotlinArray<MealzcoreSupportedLanguage *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<MealzcoreSupportedLanguage *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *value __attribute__((swift_name("value")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EnableRecipeLikeUseCase")))
@interface MealzcoreEnableRecipeLikeUseCase : MealzcoreBase <MealzcoreParameterisedUseCase>
- (instancetype)initWithUserStore:(id<MealzcoreUserStore>)userStore __attribute__((swift_name("init(userStore:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdateUserAuthInfoUseCaseInput")))
@interface MealzcoreUpdateUserAuthInfoUseCaseInput : MealzcoreBase
...
- (MealzcoreUpdateUserAuthInfoUseCaseInput *)doCopyUserId:(NSString * _Nullable)userId authorization:(MealzcoreAuthorization *)authorization __attribute__((swift_name("doCopy(userId:authorization:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreAuthorization *authorization __attribute__((swift_name("authorization")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentUseCaseInput")))
@interface MealzcorePaymentUseCaseInput : MealzcoreBase
- (instancetype)initWithTotalPrice:(double)totalPrice totalProductCount:(MealzcoreInt * _Nullable)totalProductCount clientOrderId:(NSString * _Nullable)clientOrderId __attribute__((swift_name("init(totalPrice:totalProductCount:clientOrderId:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString * _Nullable clientOrderId __attribute__((swift_name("clientOrderId")));
@property (readonly) double totalPrice __attribute__((swift_name("totalPrice")));
@property (readonly) MealzcoreInt * _Nullable totalProductCount __attribute__((swift_name("totalProductCount")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AddRecipeUseCaseInput")))
@interface MealzcoreAddRecipeUseCaseInput : MealzcoreBase
- (instancetype)initWithBasket:(MealzcoreBasket *)basket recipeToAdd:(NSArray<MealzcoreRecipeInfos *> *)recipeToAdd withoutIngredients:(BOOL)withoutIngredients __attribute__((swift_name("init(basket:recipeToAdd:withoutIngredients:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreAddRecipeUseCaseInput *)doCopyBasket:(MealzcoreBasket *)basket recipeToAdd:(NSArray<MealzcoreRecipeInfos *> *)recipeToAdd withoutIngredients:(BOOL)withoutIngredients __attribute__((swift_name("doCopy(basket:recipeToAdd:withoutIngredients:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreBasket *basket __attribute__((swift_name("basket")));
@property (readonly) NSArray<MealzcoreRecipeInfos *> *recipeToAdd __attribute__((swift_name("recipeToAdd")));
@property (readonly) BOOL withoutIngredients __attribute__((swift_name("withoutIngredients")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdateRecipesUseCaseInput")))
@interface MealzcoreUpdateRecipesUseCaseInput : MealzcoreBase
- (instancetype)initWithBasket:(MealzcoreBasket *)basket recipesToUpdate:(NSArray<MealzcoreRecipeInfos *> *)recipesToUpdate __attribute__((swift_name("init(basket:recipesToUpdate:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreUpdateRecipesUseCaseInput *)doCopyBasket:(MealzcoreBasket *)basket recipesToUpdate:(NSArray<MealzcoreRecipeInfos *> *)recipesToUpdate __attribute__((swift_name("doCopy(basket:recipesToUpdate:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreBasket *basket __attribute__((swift_name("basket")));
@property (readonly) NSArray<MealzcoreRecipeInfos *> *recipesToUpdate __attribute__((swift_name("recipesToUpdate")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RetailerInput")))
@interface MealzcoreRetailerInput : MealzcoreBase
- (instancetype)initWithRetailerId:(NSString *)retailerId retailerName:(NSString *)retailerName __attribute__((swift_name("init(retailerId:retailerName:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreRetailerInput *)doCopyRetailerId:(NSString *)retailerId retailerName:(NSString *)retailerName __attribute__((swift_name("doCopy(retailerId:retailerName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString *retailerId __attribute__((swift_name("retailerId")));
@property NSString *retailerName __attribute__((swift_name("retailerName")));
@end
...
@property (class, readonly) NSArray<MealzcoreCatalogContent *> *entries __attribute__((swift_name("entries")));
@end
...
- (void)goToFavorites __attribute__((swift_name("goToFavorites()")));
...
@property (class, readonly) NSArray<MealzcoreDialogContent *> *entries __attribute__((swift_name("entries")));
@end
...
- (instancetype)initWithRecipeId:(NSString *)recipeId isMealzId:(BOOL)isMealzId __attribute__((swift_name("init(recipeId:isMealzId:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreDynamicRecipeDetailContractEventSetRecipeId *)doCopyRecipeId:(NSString *)recipeId isMealzId:(BOOL)isMealzId __attribute__((swift_name("doCopy(recipeId:isMealzId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL isMealzId __attribute__((swift_name("isMealzId")));
@property (readonly) NSString *recipeId __attribute__((swift_name("recipeId")));
@end
...
- (instancetype)initWithRecipe:(MealzcoreBasicUiState<MealzcoreRecipe *> *)recipe recipeId:(NSString *)recipeId externalRecipeId:(NSString * _Nullable)externalRecipeId likeIsEnable:(BOOL)likeIsEnable __attribute__((swift_name("init(recipe:recipeId:externalRecipeId:likeIsEnable:)"))) __attribute__((objc_designated_initializer));
- (MealzcoreDynamicRecipeDetailContractState *)doCopyRecipe:(MealzcoreBasicUiState<MealzcoreRecipe *> *)recipe recipeId:(NSString *)recipeId externalRecipeId:(NSString * _Nullable)externalRecipeId likeIsEnable:(BOOL)likeIsEnable __attribute__((swift_name("doCopy(recipe:recipeId:externalRecipeId:likeIsEnable:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable externalRecipeId __attribute__((swift_name("externalRecipeId")));
@property (readonly) BOOL likeIsEnable __attribute__((swift_name("likeIsEnable")));
...
- (void)registerListeners __attribute__((swift_name("registerListeners()")));
- (void)viewDidAppear __attribute__((swift_name("viewDidAppear()")));
...
@property (class, readonly) NSArray<MealzcoreIngredientStatusTypes *> *entries __attribute__((swift_name("entries")));
@end
...
@interface MealzcoreFilterInstance : MealzcoreKotlinEnum<MealzcoreFilterInstance *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) MealzcoreFilterInstance *catalog __attribute__((swift_name("catalog")));
@property (class, readonly) MealzcoreFilterInstance *mealPlanner __attribute__((swift_name("mealPlanner")));
+ (MealzcoreKotlinArray<MealzcoreFilterInstance *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<MealzcoreFilterInstance *> *entries __attribute__((swift_name("entries")));
...
@property (readonly) id<MealzcoreMealPlannerStore> mealPlannerStore __attribute__((swift_name("mealPlannerStore")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)abortTransferringBasketCompletion:(void (^)(MealzcoreBasket * _Nullable))completion __attribute__((swift_name("abortTransferringBasket(completion:)")));
...
- (void)refreshBasketCompletion:(void (^)(MealzcoreBasket * _Nullable))completion __attribute__((swift_name("refreshBasket(completion:)")));
- (void)registerListeners __attribute__((swift_name("registerListeners()")));
...
@property (class, readonly) NSArray<MealzcorePreferencesContent *> *entries __attribute__((swift_name("entries")));
@end
...
- (void)clearPreferences __attribute__((swift_name("clearPreferences()")));
- (MealzcorePreferencesContractState *)createInitialState __attribute__((swift_name("createInitialState()")));
- (int32_t)getActivePreferenceCount __attribute__((swift_name("getActivePreferenceCount()")));
...
- (instancetype)initWithPrice:(MealzcoreBasicUiState<MealzcoreRecipePricing *> *)price recipeId:(NSString * _Nullable)recipeId guestNumber:(MealzcoreInt * _Nullable)guestNumber __attribute__((swift_name("init(price:recipeId:guestNumber:)"))) __attribute__((objc_designated_initializer));
- (MealzcorePricingContractState *)doCopyPrice:(MealzcoreBasicUiState<MealzcoreRecipePricing *> *)price recipeId:(NSString * _Nullable)recipeId guestNumber:(MealzcoreInt * _Nullable)guestNumber __attribute__((swift_name("doCopy(price:recipeId:guestNumber:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MealzcoreInt * _Nullable guestNumber __attribute__((swift_name("guestNumber")));
@property (readonly) MealzcoreBasicUiState<MealzcoreRecipePricing *> *price __attribute__((swift_name("price")));
...
@property (class, readonly) NSArray<MealzcoreRouterContent *> *entries __attribute__((swift_name("entries")));
@end
...
- (MealzcoreDouble * _Nullable)getDoubleOrNullKey_:(NSString *)key __attribute__((swift_name("getDoubleOrNull(key_:)")));
- (MealzcoreInt * _Nullable)getIntOrNullKey_:(NSString *)key __attribute__((swift_name("getIntOrNull(key_:)")));
- (NSString * _Nullable)getStringOrNullKey_:(NSString *)key __attribute__((swift_name("getStringOrNull(key_:)")));
- (void)putArrayKey:(NSString *)key value:(NSArray<NSString *> *)value __attribute__((swift_name("putArray(key:value:)")));
- (void)putDoubleKey:(NSString *)key value_:(double)value __attribute__((swift_name("putDouble(key:value_:)")));
- (void)putIntKey:(NSString *)key value_:(int32_t)value __attribute__((swift_name("putInt(key:value_:)")));
- (void)putStringKey:(NSString *)key value_:(NSString *)value __attribute__((swift_name("putString(key:value_:)")));
- (void)removeKeyKey_:(NSString *)key __attribute__((swift_name("removeKey(key_:)")));
@end
...
+ (double)absolutePricesSummed:(NSArray<MealzcoreBasketEntry *> *)receiver __attribute__((swift_name("absolutePricesSummed(_:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StringExtentionKt")))
@interface MealzcoreStringExtentionKt : MealzcoreBase
+ (NSString *)prettyDoubleFormat:(NSString *)receiver __attribute__((swift_name("prettyDoubleFormat(_:)")));
@end
...
- (MealzcoreResourcesImageResource *)doCopyAssetImageName:(NSString *)assetImageName bundle:(NSBundle *)bundle __attribute__((swift_name("doCopy(assetImageName:bundle:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface MealzcoreKotlinUnit : MealzcoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)unit __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MealzcoreKotlinUnit *shared __attribute__((swift_name("shared")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@protocol MealzcoreKotlinx_coroutines_coreSelectClause
@required
@property (readonly) id clauseObject __attribute__((swift_name("clauseObject")));
@property (readonly) MealzcoreKotlinUnit *(^(^ _Nullable onCancellationConstructor)(id<MealzcoreKotlinx_coroutines_coreSelectInstance>, id _Nullable, id _Nullable))(MealzcoreKotlinThrowable *) __attribute__((swift_name("onCancellationConstructor")));
@property (readonly) id _Nullable (^processResFunc)(id, id _Nullable, id _Nullable) __attribute__((swift_name("processResFunc")));
@property (readonly) void (^regFunc)(id, id<MealzcoreKotlinx_coroutines_coreSelectInstance>, id _Nullable) __attribute__((swift_name("regFunc")));
@end

__attribute__((swift_name("Kotlinx_coroutines_coreSelectClause1")))
@protocol MealzcoreKotlinx_coroutines_coreSelectClause1 <MealzcoreKotlinx_coroutines_coreSelectClause>
@required
@end
...
@protocol MealzcoreKotlinx_coroutines_coreSelectClause0 <MealzcoreKotlinx_coroutines_coreSelectClause>
@required
@end
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property (readonly) id<MealzcoreKotlinx_serialization_jsonJsonNamingStrategy> _Nullable namingStrategy __attribute__((swift_name("namingStrategy")));
...
@required
- (void)disposeOnCompletionDisposableHandle:(id<MealzcoreKotlinx_coroutines_coreDisposableHandle>)disposableHandle __attribute__((swift_name("disposeOnCompletion(disposableHandle:)")));
...
- (void)polymorphicDefaultBaseClass:(id<MealzcoreKotlinKClass>)baseClass defaultDeserializerProvider:(id<MealzcoreKotlinx_serialization_coreDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultDeserializerProvider __attribute__((swift_name("polymorphicDefault(baseClass:defaultDeserializerProvider:)"))) __attribute__((deprecated("Deprecated in favor of function with more precise name: polymorphicDefaultDeserializer")));
...
@protocol MealzcoreKotlinx_serialization_jsonJsonNamingStrategy
@required
- (NSString *)serialNameForJsonDescriptor:(id<MealzcoreKotlinx_serialization_coreSerialDescriptor>)descriptor elementIndex:(int32_t)elementIndex serialName:(NSString *)serialName __attribute__((swift_name("serialNameForJson(descriptor:elementIndex:serialName:)")));
@end
